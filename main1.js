...
var rtc_tools = new RTC_Tools(connection,$(".chat_box_dock"),$(".chat_box_content_list")) //todo: more specfici needed - currently css class... not id or whatever
  ...
  var qqqqq=rtc_tools.newChatBox()
...
//trying to get the close button to work with its chat box this.remove() etc
        ...
        this.newChatBox=function(message_obj){ //gotta pass this something
          var chb = 
          ...
          "<li class='chat_box'>\
            <div class='chat_box_title'>\
              ...
              <a class='fa fa-times fa-3 chat_box_close'>\
              </a>\
              </div>\
          ...
          chat_box_dock.append(chat_box_template);
        ...
        this.send_message=function(message){
          ...
          rtc_obj.sendCustomMessage(message);
        ...
        this.open=function(string){ //new room
          rtc_obj.open(string)
        },
        this.join=function(string){ //join existing
          rtc_obj.join(string)
        }
    }
  } 
